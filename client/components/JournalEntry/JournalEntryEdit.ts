...
export class JournalEntryEditComponent implements OnInit, OnDestroy, JournalEntryObserver {
    ...
    iname;
    ides;
    constructor(private router: Router, private repository: JournalEntryService, private activatedRoute: ActivatedRoute) {
